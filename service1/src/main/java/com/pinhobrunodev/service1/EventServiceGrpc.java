...
public final class EventServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.pinhobrunodev.service1.EventRequest,
      com.pinhobrunodev.service1.EventResponse> getCreateEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateEvent",
      requestType = com.pinhobrunodev.service1.EventRequest.class,
      responseType = com.pinhobrunodev.service1.EventResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.pinhobrunodev.service1.EventRequest,
      com.pinhobrunodev.service1.EventResponse> getCreateEventMethod() {
    io.grpc.MethodDescriptor<com.pinhobrunodev.service1.EventRequest, com.pinhobrunodev.service1.EventResponse> getCreateEventMethod;
      ...
      synchronized (EventServiceGrpc.class) {
        if ((getCreateEventMethod = EventServiceGrpc.getCreateEventMethod) == null) {
          EventServiceGrpc.getCreateEventMethod = getCreateEventMethod =
              io.grpc.MethodDescriptor.<com.pinhobrunodev.service1.EventRequest, com.pinhobrunodev.service1.EventResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pinhobrunodev.service1.EventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pinhobrunodev.service1.EventResponse.getDefaultInstance()))
  ...
  public static abstract class EventServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createEvent(com.pinhobrunodev.service1.EventRequest request,
        io.grpc.stub.StreamObserver<com.pinhobrunodev.service1.EventResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.pinhobrunodev.service1.EventRequest,
                com.pinhobrunodev.service1.EventResponse>(
  ...
  public static final class EventServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EventServiceBlockingStub> {
    ...
    /**
     */
    public com.pinhobrunodev.service1.EventResponse createEvent(com.pinhobrunodev.service1.EventRequest request) {
  ...
  public static final class EventServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EventServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.pinhobrunodev.service1.EventResponse> createEvent(
        com.pinhobrunodev.service1.EventRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_EVENT:
          serviceImpl.createEvent((com.pinhobrunodev.service1.EventRequest) request,
              (io.grpc.stub.StreamObserver<com.pinhobrunodev.service1.EventResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EventServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.pinhobrunodev.service1.CreateEventOnTrackerServiceProto.getDescriptor();
    }
